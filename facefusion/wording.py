...
WORDING: Dict[str, Any] = {
    ...
    'uis': {
        ...
        # face masker
        'face_mask_types_checkbox_group': '面膜类型',
        'face_mask_blur_slider': '面膜模糊度',
        'face_mask_padding_top_slider': '面膜上填充',
        'face_mask_padding_right_slider': '面膜右填充',
        'face_mask_padding_bottom_slider': '面膜下填充',
        'face_mask_padding_left_slider': '面膜左填充',
        'face_mask_region_checkbox_group': '面膜区域',
        # face selector
